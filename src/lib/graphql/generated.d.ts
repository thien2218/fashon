...
export type GetBooksQuery = { __typename?: 'query_root', books: Array<{ __typename?: 'books', id: any, genre: string, language: string, title: string, subtitle?: string | null, price: number, cover_url: string }> };
